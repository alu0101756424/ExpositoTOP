...
/**
 * @file mainTOPTW.java
 * @brief Programa de ejecución para experimentos sobre instancias TOPTW.
 * @details Lee instancias desde el directorio "Instances/TOPTW", construye
 *          problemas con TOPTWReader, crea soluciones iniciales y ejecuta
 *          el metaheurístico GRASP con varios parámetros.
 * @author alu0101756424
 * @date 2025
 */
/**
 * @brief Clase principal que prepara y lanza los experimentos TOPTW.
 * @details
 * - Construye un arreglo con los nombres de fichero de las instancias.
 * - Para cada instancia lee el problema, inicializa una solución y ejecuta
 *   el algoritmo GRASP con distintos tamaños de búsqueda.
 * @see TOPTWReader
 * @see TOPTWSolution
 * @see TOPTWGRASP
 */
public class mainTOPTW {
    /**
     * @brief Arreglo con los nombres de las instancias TOPTW.
     * @details Contiene 29 ficheros organizados en carpetas tipo c*, r*, rc*.
     */
